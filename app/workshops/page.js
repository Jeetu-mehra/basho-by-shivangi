    ...
    <div className="bg-stone-50 min-h-screen">
      ...
      <div className="bg-basho-earth text-white py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="font-serif text-5xl md:text-6xl mb-6">The Studio Sessions</h1>
          <p className="text-basho-sand text-lg max-w-2xl mx-auto leading-relaxed">
            Immerse yourself in the tactile art of ceramics. Our workshops are designed 
            to slow down time and reconnect your hands with the earth.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        {workshops.length === 0 ? (
          <div className="text-center py-20">
            <h3 className="text-2xl font-serif text-stone-400">No workshops scheduled right now.</h3>
            <p className="text-stone-500 mt-2">Check back soon for new dates.</p>
          </div>
        ) : (
